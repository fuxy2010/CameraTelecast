...
#define __IDxtCompositor_INTERFACE_DEFINED__   //hzq
#define __IDxtAlphaSetter_INTERFACE_DEFINED__   //hzq
#define __IDxtJpeg_INTERFACE_DEFINED__   //hzq
#define __IDxtKey_INTERFACE_DEFINED__   //hzq
//#include "dxtrans.h"  //hzq
